...
- **约束**: 不 reload OpenResty；不重 attach BPF；Rust loader 为默认实现
...
| M2-3 | list / list -count | `sudo ./rust/loader/target/release/waf-sklookup-loader list` | ☐ |
| M2-4 | bulk **open** range/file，无 nginx reload | `sudo ./rust/loader/target/release/waf-sklookup-loader bulk open -range 20000-20010` | ☐ |
| M2-4b | bulk **close** range/file | `sudo ./rust/loader/target/release/waf-sklookup-loader bulk close -range 20000-20010` | ☐ |
