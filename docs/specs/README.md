...
| [SDD-004](SDD-004-nft-dnat-last-resort.md) | Optional last-resort nftables DNAT when **both** `sk_lookup` links are gone | Scripts + docs; default OFF; no production auto-enable |
